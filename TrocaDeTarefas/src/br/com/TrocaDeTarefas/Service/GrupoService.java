...
public class GrupoService implements IGrupoService{
	...
	public String adicionarParticipante(Usuario usuario, Grupo grupo) {
		...
		try{
			System.out.println("2� passo grupoServico");
			...
			msgError = "N�o foi poss�vel adicionar usuario ao grupo! "+e.getMessage();
		}finally{
	...
	public String criarGrupo(Grupo grupo) {
		...
		try{
			...
			msgError = "N�o foi poss�vel Criar o grupo! "+e.getMessage();
		}finally{
			return msgError;
		}
	}
	...
	public String removerGrupo(Grupo grupo) {
		...
		try{
			...
			msgError = "N�o foi poss�vel remover! "+e.getMessage();
		}finally{
			return msgError;
		}
	...
	//		meuGrupo.update(arg1, arg2, arg3);
			...
			msgError = "N�o foi poss�vel atualizar o grupo! "+e.getMessage();
		}finally{
			return msgError;
		}
	}
